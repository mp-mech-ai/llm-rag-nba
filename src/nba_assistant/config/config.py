...
* SQLDatabaseToolkit : Pour interroger une base de données structurée (SQL) contenant des statistiques, des informations sur les joueurs, les équipes, etc.
...
Utilise SQLDatabaseToolkit pour répondre aux questions nécessitant des données structurées (ex : statistiques, classements, performances individuelles). 
